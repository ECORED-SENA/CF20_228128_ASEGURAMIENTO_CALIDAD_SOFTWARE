  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Vulnerabilidades de seguridad
        p.mb-4 Fortalecer la comprensión de las características fundamentales de conceptos seleccionados en seguridad y aseguramiento de #[em software]. 
